...
import { CarbonDioxideConcentrationMeasurementServer as Base } from "@matter/main/behaviors/carbon-dioxide-concentration-measurement";
...
class CarbonDioxideConcentrationMeasurementServerBase extends FeaturedBase {
  declare state: CarbonDioxideConcentrationMeasurementServerBase.State;
...
namespace CarbonDioxideConcentrationMeasurementServerBase {
  export class State extends FeaturedBase.State {
    config!: CarbonDioxideConcentrationMeasurementConfig;
  }
}

export function CarbonDioxideConcentrationMeasurementServer(
  config: CarbonDioxideConcentrationMeasurementConfig,
) {
  return CarbonDioxideConcentrationMeasurementServerBase.set({ config });
}
